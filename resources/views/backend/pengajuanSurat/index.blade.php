...
@section('backend')
    ...
    <div class="container-fluid">
        ...
        @if (Auth::user()->user_role != 'Staff')
            <a href="{{ route('pagePdf') }}" class="btn btn-dark">Print Laporan &nbsp;<svg
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="text-right">
                                                    <a href="{{ Storage::url($d->file) }}" download="" class="btn btn-dark">
                                                        <i class="fa fa-download"></i></a>
                                                        <br>
                                                        <br>
                                                        {{-- pdf file --}}
                                                        <iframe src="{{ Storage::url($d->file) }}"
                                                            width="450px" height="700px"></iframe>
                                                    <hr>
                                                </div>
                                            </div>
                                        </div>
